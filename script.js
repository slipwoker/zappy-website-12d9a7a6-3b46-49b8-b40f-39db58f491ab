    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אריה נכסים - תל אביב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '12d9a7a6-3b46-49b8-b40f-39db58f491ab',
                    name: data.name || '',
                    email: data.email || '',
